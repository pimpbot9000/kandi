...
\title{DNS Enumeration Techniques}
% 2-osainen otsikko:
...
% fortsätter ännu}
\ENTITLE{DNS Enumeration Techniques}
...
%\DATE{12. huhtikuuta 2021}
%\DATE{Den 31 februari 2011}
\ENDATE{April 12, 2021}

% Kurssin vastuuopettaja ja työsi ohjaaja(t)
\SUPERVISOR{Professori Tuomas Aura}
\INSTRUCTOR{Tohtoriopiskelija Jacopo Bufalino}
...
\ENSUPERVISOR{Tuomas Aura, Professor}
\ENINSTRUCTOR{Jacopo Bufalino, Doctoral Candidate}
% M.Sc. (Tech)  // M.Sc. (Eng)
% Lic.Sc. (Tech)
...
\KEYWORDS{DNS, domain name system, nimipalvelinjärjestelmä, palvelukartoitus}
\ENKEYWORDS{DNS, domain name system, DNS enumeration, service enumeration}
...
%\bibliography{english}{lahteet}
%\bibliographystyle{english}
